!function(t) {
    ...
    t.fn.thmobilemenu = function(e) {
        ...
        return this.each((function() {
            ...
            function s() {
                ...
                t(s).each((function() {
                    t(this).hasClass(a.subMenuToggleClass) && (t(this).removeClass(a.subMenuToggleClass),
            ...
            t(i).each((function() {
                t(this).on("click", (function(e) {
                    ...
                    e.preventDefault(),
                    s = t(this).parent(),
                    t(s).next("ul").length > 0 ? (t(s).parent().toggleClass(a.subMenuParentToggle),
                    t(s).next("ul").slideToggle(a.toggleSpeed),
                    t(s).next("ul").toggleClass(a.subMenuToggleClass)) : t(s).prev("ul").length > 0 && (t(s).parent().toggleClass(a.subMenuParentToggle),
    ...
    var o, r, c, l = ".ajax-contact", d = '[name="email"]', h = t(".form-messages");
    function p() {
        var e = t(l).serialize();
        (function() {
            var e, a = !0;
            function s(s) {
                ...
                for (var i = 0; i < s.length; i++)
                    e = l + " " + s[i],
                    t(e).val() ? (t(e).removeClass("is-invalid"),
                    a = !0) : (t(e).addClass("is-invalid"),
                    a = !1)
            }
            s('[name="name"],[name="email"],[name="subject"],[name="number"],[name="message"]'),
            t(d).val() && t(d).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (t(d).removeClass("is-invalid"),
            a = !0) : (t(d).addClass("is-invalid"),
            a = !1);
            return a
        }
        )() && jQuery.ajax({
            ...
            h.addClass("error"),
            "" !== t.responseText ? h.html(t.responseText) : h.html("Oops! An error occured and your message could not be sent.")
        }
        ))
    }
    function u(t) {
    ...
    t.fn.sectionPosition = function(e, a) {
        t(this).each((function() {
            ...
            "top-half" === i ? (t(n).css("padding-bottom", r + s + "px"),
            c.css("margin-top", "-" + s + "px")) : "bottom-half" === i && (t(n).css("padding-top", o + s + "px"),
    ...
    function f() {
        t(".feature-circle .progressbar").each((function() {
            ...
            parseInt(100, 10),
            t(this).data("animate"));
            a < s + t(window).height() - 30 && !n && (t(this).data("animate", !0),
            t(this).find(".circle").circleProgress({
        ...
        t(".skill-circle .progressbar").each((function() {
            ...
            parseInt(100, 10),
            t(this).data("animate"));
            e < a + t(window).height() - 30 && !i && (t(this).data("animate", !0),
            t(this).find(".circle").circleProgress({
                startAngle: -Math.PI / 2,
                value: s / 100,
                size: 100,
    ...
    t(".progress-bar").waypoint((function() {
        t(".progress-bar").css({
    ...
    t(".price_slider").slider({
        ...
        values: [10, 75],
        slide: function(e, a) {
            t(".from").text("$" + a.values[0]),
            t(".to").text("$" + a.values[1])
        }
    }),
    ...
    function g() {
        ...
        m[a].then(a=>{
            ...
            e.attr("width") && (s.attr("width", e.attr("width")),
            e.attr("height") || s.removeAttr("height")),
            e.attr("height") && (s.attr("height", e.attr("height")),
    ...
    t.fn.lettering = function(e) {
        return e && b[e] ? b[e].apply(this, [].slice.call(arguments, 1)) : "letters" !== e && e ? (t.error("Method " + e + " does not exist on jQuery.lettering"),
        this) : b.init.apply(this, [].slice.call(arguments, 0))
    }
    ,
    ...
    t.fn.countdown = function() {
        t(this).each((function() {
            ...
            var i = setInterval((function() {
                ...
                n < 0 ? (clearInterval(i),
                e.addClass("expired"),
                e.find(".message").css("display", "block")) : (s(".day").html(o),
                s(".hour").html(r),
                s(".minute").html(c),
                s(".seconds").html(l))
            }
